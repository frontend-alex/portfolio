...
const AnimatedButton = () => {
  return (
    <a href="#" id="hoverElement" className="link-button">
	<svg viewBox='0 0 200 200' width='200' height='200' xmlns='http://www.w3.org/2000/svg' className="link__svg dark:stroke-white dark:fill-white" aria-labelledby="link1-title link1-desc">
